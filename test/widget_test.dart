...
//                   ),
//                   hintText: 'Search',
//                   hintStyle: TextStyle(color: white.withOpacity(0.6), fontWeight: light),
//                   filled: true,
...
//                       _searchResults =
//                           _movieRepository.searchMovies(keyword);
//                     },
//                   ),
...
//                                               Gap(6),
//                                               Text('4.7', style: TextStyle(fontSize: 14, fontWeight: medium),),
//                                             ],
//                                           ),
//                                         ],
//                                       ),
...
//                                       ),
//                                       child: Text('DETAILS', style: TextStyle(color: black, fontWeight: bold, fontSize: 12),),
//                                     ),
//                                   ],
//                                 ),
//                                 Gap(10),
...
//                                             style: TextStyle(fontSize: 14, fontWeight: light, color: white.withOpacity(0.7),))
//                                     ),
//                                     Container(
//                                         width: size.width / 4 - 16,
//                                         child: Text('T16', textAlign: TextAlign.center,
//                                             style: TextStyle(fontSize: 14, fontWeight: light, color: white.withOpacity(0.7),))
//                                     ),
//                                     Container(
//                                         width: size.width / 4 - 16,
//                                         child: Text('20/05/2024', textAlign: TextAlign.end,
//                                             style: TextStyle(fontSize: 14, fontWeight: light, color: white.withOpacity(0.7),))
//                                     ),
//                                   ],
//                                 ),
